...
import 'package:flutter_file_manager_ui/pages/file_detail_page.dart';
            ...
            child: GestureDetector(
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text("云空间",style: TextStyle(
                      fontSize: 15,
                      color: white,
            ...
            child: GestureDetector(
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text("办公云空间",style: TextStyle(
                      fontSize: 15,
                      color: white,
                      fontWeight: FontWeight.w500
                    ),),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(myCloudFilesContentJson[index]['title']+" ( ${myCloudFilesContentJson[index]['file_count']} )",style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500
                ),)
              ],
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15,),
                Text(teamCloudFilesContentJson[index]['title']+" ( ${teamCloudFilesContentJson[index]['file_count']} )",style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500
                ),)
              ],
