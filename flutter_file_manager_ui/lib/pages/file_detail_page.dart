...
class _FileDetailPageState extends State<FileDetailPage> {
  ...
  Widget getAppBar(){
    return AppBar(
      ...
      }, icon: const Icon(LineIcons.arrowLeft,color: black,)),
      title: Text("${widget.title} (${widget.fileCount})",style: const TextStyle(
        color: black,
        fontSize: 17
      ),),
    );
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(imageFiles[index]['file_name'],style: const TextStyle(
                  fontSize: 15,
